...
## Memory surfaces
- **Project memory** — durable team/project knowledge (persist via project memory tools)
- **Notepad priority** — short high-signal context for the next turns
- **Notepad working** — temporary active-session notes
- **Docs / AGENTS / CLAUDE / COPILOT files** — durable instructions and conventions when they truly belong there
