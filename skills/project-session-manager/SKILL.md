...
> **Quick Start (worktree-first):** Start with `omcp teleport` when you want an isolated issue/PR/feature worktree before adding any tmux/session orchestration:
> ```bash
> omcp teleport #123          # Create worktree for issue/PR
> omcp teleport my-feature    # Create worktree for feature
> omcp teleport list          # List worktrees
> ```
...
The `omcp teleport` command provides a lightweight alternative to full PSM sessions. It creates git worktrees without tmux session management — ideal for quick, isolated development.
...
omcp teleport #123
omcp teleport owner/repo#123
omcp teleport https://github.com/owner/repo/issues/42

# Create worktree for a feature
omcp teleport my-feature

# List existing worktrees
omcp teleport list

# Remove a worktree
omcp teleport remove issue/my-repo-123
omcp teleport remove --force feat/my-repo-my-feature
```
