...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - `/fleet` to spin up a parallel local subagent (e.g., another `test-engineer`) for test strategy validation
      - `/delegate` to push a long-running, large-scale test analysis to a GitHub-hosted Copilot session
