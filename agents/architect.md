...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - `/fleet` to spin up a parallel local subagent (e.g., the `critic` agent) for plan/design challenge
      - `/delegate` to push a long-running architectural analysis to a GitHub-hosted Copilot session
  ...
  <Output_Format>
    ...
    - `path\to\other.ts:108` - [what it shows]
  </Output_Format>
