...
<Agent_Prompt>
  ...
  <Execution_Policy>
    ...
    - Quick inspections (haiku/gpt-5-mini tier): .head(), .describe(), value_counts. Speed over depth.
    - Deep analysis (sonnet/gpt-5.2-codex tier): multi-step analysis, statistical testing, visualization, full report.
