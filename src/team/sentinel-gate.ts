 ...
 *
 * Combines factcheck and sentinel log health checks into a single readiness
 * signal for team runtime consumers. Ported from oh-my-claudecode team library.
 */

import { runFactcheck } from "../lib/factcheck/index.js";
import { checkSentinelHealth } from "../lib/factcheck/sentinel.js";
import { loadGuardsConfig } from "../lib/factcheck/config.js";
import type { FactcheckResult } from "../lib/factcheck/types.js";
