 ...
 *
 * This is the heuristic context window; tune for Copilot model selection if
 * needed. The env-var overrides allow operators to adjust for 1M-context
 * models without code changes.
 */
export const CLAUDE_DEFAULT_CONTEXT_LIMIT =
  process.env.ANTHROPIC_1M_CONTEXT === "true" ||
  process.env.VERTEX_ANTHROPIC_1M_CONTEXT === "true" ||
  process.env.OMCP_1M_CONTEXT === "true"
    ? 1_000_000
    : 200_000;
