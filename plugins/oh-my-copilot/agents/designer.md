...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - `/fleet` to spin up a parallel local `designer` subagent for UI/UX cross-validation
      - `/delegate` to push large-scale frontend work to a GitHub-hosted Copilot session
